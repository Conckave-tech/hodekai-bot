// ============================================
// 🖤 HODEKAI BOT v5.0 - QR FIXED
// CONCLAVE HOLDINGS - WHATSAPP + RENDER
// ============================================
...
function handleMessage(msg, userNumber, isSticker, groupId) {
    ...
    if (cmd === 'removemoney') {
        ...
        const remTarget = args[1],
            remAmt = parseInt(args[2]);
    ...
    if (cmd === 'setrole') {
        ...
        const roleTarget = args[1],
            newRole = args[2].toUpperCase();
